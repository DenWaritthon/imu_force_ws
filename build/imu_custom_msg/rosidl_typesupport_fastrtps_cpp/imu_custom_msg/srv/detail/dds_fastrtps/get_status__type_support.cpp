...
#include "imu_custom_msg/srv/detail/get_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = imu_custom_msg::srv::GetStatus_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const imu_custom_msg::srv::GetStatus_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<imu_custom_msg::srv::GetStatus_Request *>(
    untyped_ros_message);
...
{
  return &imu_custom_msg::srv::typesupport_fastrtps_cpp::_GetStatus_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = imu_custom_msg::srv::GetStatus_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const imu_custom_msg::srv::GetStatus_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<imu_custom_msg::srv::GetStatus_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &imu_custom_msg::srv::typesupport_fastrtps_cpp::_GetStatus_Response__handle;
}
...
{
  return &imu_custom_msg::srv::typesupport_fastrtps_cpp::_GetStatus__handle;
}
