...
#ifndef IMU_CUSTOM_MSG__SRV__DETAIL__GET_STATUS__FUNCTIONS_H_
#define IMU_CUSTOM_MSG__SRV__DETAIL__GET_STATUS__FUNCTIONS_H_
...
#include "imu_custom_msg/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_imu_custom_msg
bool
 ...
 * calls
 * imu_custom_msg__srv__GetStatus_Request__init().
...
/**
 * It calls
 * imu_custom_msg__srv__GetStatus_Request__fini()
 ...
 * imu_custom_msg__srv__GetStatus_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * imu_custom_msg__srv__GetStatus_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * imu_custom_msg__srv__GetStatus_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_imu_custom_msg
...
/**
 * It calls
 * imu_custom_msg__srv__GetStatus_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_imu_custom_msg
...
/**
 * It allocates the memory for the array and calls
 * imu_custom_msg__srv__GetStatus_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_imu_custom_msg
...
/**
 * It calls
 * imu_custom_msg__srv__GetStatus_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // IMU_CUSTOM_MSG__SRV__DETAIL__GET_STATUS__FUNCTIONS_H_
