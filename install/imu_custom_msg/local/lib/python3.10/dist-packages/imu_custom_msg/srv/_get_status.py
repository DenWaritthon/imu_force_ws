...
class Metaclass_GetStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from imu_custom_msg.srv import _get_status
...
class GetStatus(metaclass=Metaclass_GetStatus):
    from imu_custom_msg.srv._get_status import GetStatus_Request as Request
    from imu_custom_msg.srv._get_status import GetStatus_Response as Response
